...
-- shakesoda calls this file pump.lua

-- AllowOptionsMenu()
-- [en] returns if you are able to select options on ScreenSelectMusic.
function AllowOptionsMenu()
	return not GAMESTATE:IsAnExtraStage() and not GAMESTATE:GetPlayMode() == "PlayMode_Oni"
end

local function CurGameName() return GAMESTATE:GetCurrentGame():GetName() end
