...
return Def.ActorFrame{
	Def.ActorFrame{
		...
		Def.ActorFrame{
			...
			LoadActor(THEME:GetPathG("","_cautiontape"))..{
				Name="Tape";
				InitCommand=cmd(zoomto,SCREEN_WIDTH,32;customtexturerect,0,0,SCREEN_WIDTH/self:GetWidth(),1;texcoordvelocity,8,0;fadetop,1/5;fadebottom,1/3);
			};
		};
		Def.ActorFrame{
			Name="Bottom";
	...
	LoadActor(THEME:GetPathG("_caution","sign"))..{
	...
	LoadFont("_francophilsans normal 24px")..{
		Name="Warning";
		Text=THEME:GetString("_construction","Warning");
